...
function clientBuilder(CONFIG, RUN_PARAMS) {
    ...
    const { staticDir, build: { output: { target, publicPath, filenames }, input, aliases, postProcessWebpackConfig //, outputESM = true
     } } = CONFIG;
    const nodeModulesPaths = [PATHS.nodeModules];
    RUN_PARAMS._isSelfDevelopment || nodeModulesPaths.push(PATHS.cwdNodeModules);
